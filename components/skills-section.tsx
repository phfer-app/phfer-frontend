...
export function SkillsSection() {
  ...
  return (
    <section id="skills" className="py-24 relative">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-primary/25 dark:bg-primary/15 rounded-full blur-3xl opacity-50 dark:opacity-30 -z-10"></div>
      <div className="absolute top-1/4 right-1/4 w-[500px] h-[500px] bg-secondary/25 dark:bg-secondary/15 rounded-full blur-3xl opacity-50 dark:opacity-30 -z-10"></div>
      <div className="absolute bottom-1/3 left-1/4 w-[400px] h-[400px] bg-primary/22 dark:bg-primary/12 rounded-full blur-3xl opacity-45 dark:opacity-25 -z-10"></div>
